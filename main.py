# https://www.youtube.com/watch?v=s5bd9KMSSW4&ab_channel=CodingWithRuss
...
# pygame.mixer.Sound("assets/audio/music.mp3")
...
bg_image = pygame.image.load("assets/images/background/background_2.jpg").convert_alpha()
